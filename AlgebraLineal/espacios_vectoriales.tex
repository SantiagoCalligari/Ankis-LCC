...
\begin{tikzpicture}[remember picture, overlay]
    ...
    { % Content for R3, C1
      ...
      \item Sea $V$ un $F$-$ev$ y $S \in V \Rightarrow span(S) \in V$ subespacio
    \end{itemize}
    ...
    { % Content for R3, C2
      ...
      \begin{itemize}
        \item La suma de subespacios vectoriales es un subespacio.
      \end{itemize}
    ...
    \item $dim(U+V) = Dim(U) + Dim(V) - Dim(U \cap V)$
      \end{itemize}
    };
